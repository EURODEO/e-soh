...
public:
    ...
    std::list<DescriptorId> expandDescriptor(const DescriptorId d, bool recursive=false) const;
    const std::list<DescriptorId> & at(DescriptorId d, bool ignore_throw = false) const; // TODO: exception: out_of_range
    ssize_t size() const;
